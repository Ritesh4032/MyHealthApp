...
class MYWEIGHTINTERFACE extends StatefulWidget {
  const MYWEIGHTINTERFACE({super.key});

  @override
  State<MYWEIGHTINTERFACE> createState() => _MyWeightCaloriesState();
}

class _MyWeightCaloriesState extends State<MYWEIGHTINTERFACE> {
  @override
